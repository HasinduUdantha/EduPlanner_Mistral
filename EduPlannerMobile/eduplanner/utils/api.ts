...
export const generateStudyPlan = async (data: {
  ...
  try {
    ...
    const message = error.response?.data?.error || error.message || 'Failed to generate study plan';
    throw new Error(message);
  }
};
...
export const updateStudyPlan = async (
  ...
  try {
    const response = await apiClient.post('/update-plan', {
      planId,
      feedback,
    });
    ...
    const message = error.response?.data?.error || error.message || 'Failed to update study plan';
    throw new Error(message);
  }
};
...
export const getUserPlans = async (userId: string) => {
  try {
    ...
    const message = error.response?.data?.error || error.message || 'Failed to fetch user plans';
    throw new Error(message);
  }
};

// In your api.ts file, add this function if it's missing:
export const getStudyPlan = async (planId: string) => {
  try {
    const response = await apiClient.get(`/plan/${planId}`);
    return response.data;
  } catch (error: any) {
    const message = error.response?.data?.error || error.message || 'Failed to fetch study plan';
    throw new Error(message);
  }
};
...
export const deleteStudyPlan = async (planId: string) => {
  try {
    ...
    const message = error.response?.data?.error || error.message || 'Failed to delete study plan';
    throw new Error(message);
  }
};

// FIXED: Match backend endpoints
export const getLatestStudyPlan = async (userId: string) => {
  try {
    const response = await apiClient.get(`/study-plan-latest/${userId}`);
    return response.data;
  } catch (error: any) {
    const message = error.response?.data?.error || error.message || 'Failed to fetch latest study plan';
    throw new Error(message);
  }
};

export const getStudyPlanHistory = async (userId: string) => {
  try {
    const response = await apiClient.get(`/study-plan-history/${userId}`);
    return response.data;
  } catch (error: any) {
    const message = error.response?.data?.error || error.message || 'Failed to fetch study plan history';
    throw new Error(message);
  }
};
...
export const getDailyMotivation = async () => {
  try {
    ...
    const message = error.response?.data?.error || error.message || 'Failed to fetch daily motivation';
    throw new Error(message);
  }
};
